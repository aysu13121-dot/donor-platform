# Qan Donoru Platforması — v2 (Next.js + Flask)

Bu qovluq layihənin sıfırdan, təmiz mimari ilə yazılmış versiyasıdır:
...
Köhnə versiya (`/frontend`, `/app.py`, `/appfronted.py`, `/templates`, `/static`)
toxunulmadan qalıb — bu, ona paralel, ayrı bir tətbiqdir.
