...
const T = {
  az: {
    ...
    dashboard: {
      ...
      statTotal: 'Ümumi sorğu',
      statActive: 'Aktiv sorğu',
      statFulfilled: 'Tamamlanan',
      statDonorStatus: 'Donorluq statusu',
      tablePatient: 'Xəstə',
      tableLocation: 'Xəstəxana / Şəhər',
      tableUnits: 'Vahid',
      tableUrgency: 'Təciliyyət',
      tableStatus: 'Status',
      tableActions: 'Əməliyyat',
  ...
  en: {
    nav: {
      ...
      dashboard: 'Dashboard', login: 'Log in', register: 'Register', logout: 'Log out',
    },
    hero: {
    ...
    dashboard: {
      ...
      statActive: 'Active requests',
      statFulfilled: 'Fulfilled',
      statDonorStatus: 'Donor status',
      tablePatient: 'Patient',
      tableLocation: 'Hospital / City',
      tableUnits: 'Units',
