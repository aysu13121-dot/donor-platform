...
<script>
	...
	// `href` verilibsə <a>, yoxdursa <button> kimi render olunur - köhnə
	// React versiyasındakı `as={Link}` pattern-inin Svelte qarşılığı.
	let { class: className, variant, size, href, children, ...rest } = $props();
</script>
